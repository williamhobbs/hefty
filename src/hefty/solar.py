...
def nwp_fetcher(date, model, product, member, priority, search_str,
                fxx_range, latitude, longitude, attempts,
                hrrr_coursen_window, cams_api_key, cams_area):
    ...
    if model != 'cams':
        ...
        for fxx in fxx_range:
            ...
            # merge - override avoids hight conflict between 2m temp and
            # 10m wind
